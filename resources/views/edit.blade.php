...
<body>
    ...
    <center>
    <div class="container">
        <form action="{{ route('update', $game->id) }}" method="post">
            @csrf
            @method('put')
            <section class="base">
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('judul') is-invalid @enderror" id="judul" name="judul"
                    value="{{$game->judul}}" placeholder="Masukkan judul" required>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('tahun') is-invalid @enderror" id="tahun" name="tahun"
                    value="{{$game->tahun}}" placeholder="Masukkan tahun" required>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('platform') is-invalid @enderror" id="platform" name="platform"
                    value="{{$game->platform}}" placeholder="Masukkan platform" required>
            ...
            <div class="mb-3">
                ...
                <select style="background-color: white;" name="pengembang_id" id="pengembang_id" class="form-select @error('pengembang_id') is-invalid @enderror"
                    ...
                    <option value={{ $pub->id }} @php echo $pub->id == $game->pengembang_id ? 'selected' : ''; @endphp>{{ $pub->pengembang }}</option>
                    @endforeach
                </select>
                @error('pengembang_id')
                    <div class="invalid-feedback">{{ $message }}</div>
